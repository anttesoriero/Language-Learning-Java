# Language-Learning Project - Java
...
###### Status: Not started
Solve the [semester homework problem](https://github.com/anttesoriero/Language-Learning-Python/blob/master/SEMESTERHW.md) (that is, the problem you've solved in Scheme, Ada, and Prolog) in your chosen language. If needed, you may adapt the input/output format of the problem to fit your language. For example, you may use conventional input/output, or you may write a function that takes the "input" as its parameters and returns the "output" value, or you may use a web-based interface.
